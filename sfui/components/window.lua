    ...
    if type(self.paint) == "function" then
        ...
        if type(self.override_design) == "function" then
            ...
            if self.can_maximise and self.resizable then
                ...
                render.drawRect(self.mins.x + self.size.x - self.barheight*2 + 2, self.mins.y + 4, self.barheight - 6, 3)
                render.drawRectOutline(self.mins.x + self.size.x - self.barheight*2 + 2, self.mins.y + 4, self.barheight - 4, (self.barheight - 6) * self.aspectRatio)
            end
            //
